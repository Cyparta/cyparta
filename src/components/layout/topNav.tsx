...
const TopNav = () => {
  return (
    <Box className="top-nav" sx={{ background: "rgba(49, 47, 48, 1)", color: "#fff", padding: "10px", boxShadow:"0px 1px 2px #A49FA1" }}>
      <Container>
        <Grid container alignItems="center" sx={{flexWrap: "wrap"}} spacing={2}>
          <Grid item xs={6}>
