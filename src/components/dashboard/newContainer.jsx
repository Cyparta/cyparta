              ...
              {columns.map((col, index) =>
                col.type === "text" ? (
                  <TableCell
                    ...
                    align="center"
                  >
                    {/* {console.log(row[col.main][col.name])} */}
                    {row[col.main][col.name]}
                  </TableCell>
                ) : col.type === "rating" ? (
                  ...
                  <TableCell align="center">
                    ...
                    <button onClick={() => dispatch(RequestDeleteEmploye(row.id))}>Delete Button</button>
                    <button onClick={() => console.log("yes")}>update Button</button>
                  </TableCell>
                ) : (
                  <TableCell align="center">
                    {/* <img src={person1} alt={row[col.name]} /> */}
