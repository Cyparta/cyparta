...
const ContactUs = () => {
    ...
    // contactInfo
    const contactInfo = useSelector((state: RootState) => state.lang.value.contactInfo)
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            dispatch(RequestPostContact({ name, email, services, phone_number, summary }))
            resetForm()
        },
    });
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            >
                                ...
                                <Box sx={{ display: "flex", justifyContent: "center" }}>
                                    <MainButton type="submit" disabled={loading}>{loading ? contactUs.loading[lang] : contactUs.send[lang] }</MainButton>
